...
WLIBS = -lws2_32 -lopengl32 -lgdi32 -llua -ljson-c -lphysfs -lportaudio -lopus
MLIBS = -framework OpenGL -framework Cocoa -llua -ljson-c -lphysfs -lopus
LLIBS = -lpthread -lGLU -lGL -lX11 -llua -ljson-c -lphysfs -lopus
