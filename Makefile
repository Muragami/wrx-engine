...
LLIBS = -lGLU -lGL -lX11 -llua -ljson-c

windows: $(OBJS)wwrx.exe

$(OBJS)wwrx.exe: $(OBJS)main.w.o $(OBJS)tigr.w.o $(OBJS)data.w.o $(OBJS)core.w.o $(OBJS)lua.w.o
	clang $(CFLAGS) $(OPTFLAGS) -o $(OBJS)wwrx.exe $(OBJS)main.w.o $(OBJS)tigr.w.o $(OBJS)data.w.o $(OBJS)core.w.o $(OBJS)lua.w.o $(WLIBS)
...
$(OBJS)mwrx: $(OBJS)main.m.o $(OBJS)tigr.m.o $(OBJS)data.m.o $(OBJS)core.m.o $(OBJS)lua.m.o
	clang $(CFLAGS) $(OPTFLAGS) -o $(OBJS)mwrx $(OBJS)main.m.o $(OBJS)tigr.m.o $(OBJS)data.m.o $(OBJS)core.m.o $(OBJS)lua.m.o $(MLIBS)
